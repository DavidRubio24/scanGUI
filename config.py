# En este archivo se puede elegir la camara a usar, el puerto USB al que conectar las luces, la intensidad por defecto de las luces y el directorio en que guardar las imágenes.
